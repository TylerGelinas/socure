 ...
 * @since AM 5.5.0
 */
public class socureNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(socureNodePlugin.currentVersion, 
				Collections.singletonList(socureNode.class));
	}
	...
	public void upgrade(String fromVersion) throws PluginException {
		pluginTools.upgradeAuthNode(socureNode.class);
	...
	public String getPluginVersion() {
		return socureNodePlugin.currentVersion;
	}
}
